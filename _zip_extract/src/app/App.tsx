                ...
                <div className="w-full max-w-[560px] grid grid-cols-2 gap-2">
                  {recommendedQuestions.map((item, i) => (
                    <button
                      ...
                      className="text-left px-4 py-5 rounded-xl bg-[#f5f5f5] border-[0.5px] border-[#e8e8e8] hover:border-[#534AB7] hover:text-[#534AB7] transition-colors text-[12px] text-[#aaa] leading-snug h-[80px] flex items-center"
                    >
                      {item.query}
                    </button>
                  ))}
